...
public partial class SettingsViewModel : ObservableObject
{
    ...
    protected override void OnPropertyChanged(System.ComponentModel.PropertyChangedEventArgs e)
    {
        ...
        if (e.PropertyName is not (nameof(IsDirty) or nameof(ShowPermissionSection)))
            IsDirty = true;
    }
    ...
    public event Action? RequestShowPermissionCheck;

    [RelayCommand]
    private void CheckPermissions() => RequestShowPermissionCheck?.Invoke();
