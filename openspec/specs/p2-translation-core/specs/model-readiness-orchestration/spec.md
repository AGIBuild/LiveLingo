...
Model readiness orchestration provides a unified service for checking translation and post-processing model availability. The pipeline and related Core services use this service instead of direct filesystem probing, ensuring consistent readiness checks and typed error handling when required models are missing.
